...
Preconditions and postcodition utilities

* `require` :
* `ensure` : used to launch specific asserts (for exemple on existence of the generated artifacts)
* `invariant` :
* `assert_exists`: asserts that specified file exists
